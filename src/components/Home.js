        ...
        <div className="hero-content">
          ...
          <div className="hero-title">
            ...
            <span
              ...
              data-text-en="Full Stack Developer & UI/UX Designer"
              data-text-ar="مطور Full Stack & مصمم UI/UX"
            >
          ...
          >
            I’m a passionate WordPress and React developer dedicated to crafting
            fast, secure, and visually appealing websites and web applications
          ...
          <div className="hero-social">
            <a href="https://github.com/samadtariq" className="social-icon" title="GitHub">
              <i className="fab fa-github"></i>
            </a>
            <a href="https://www.linkedin.com/in/abdul-samad-01b285336/?skipRedirect=true" className="social-icon" title="LinkedIn">
              <i className="fab fa-linkedin-in"></i>
            </a>
            <a href="https://www.instagram.com/samad._.developer/" className="social-icon" title="Instagram">
